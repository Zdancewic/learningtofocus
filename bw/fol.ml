...
let rec open_rt_aux i u r =
  ...
  match r with
    ...
    | Un_all r1           -> Un_all (open_rt_aux (i+1) u r)
    | Un_ex  r1           -> Un_ex (open_rt_aux (i+1) u r)
...
let rec close_rt_aux i x r =
    ...
    | Un_all r1           -> Un_all (close_rt_aux (i+1) x r)
    | Un_ex  r1           -> Un_ex (close_rt_aux (i+1) x r)
...
let rec subst_tr x u r =
  ...
  match r with
    ...
    | Un_all r1           -> Un_all (subst_tr_xu r)
    | Un_ex  r1           -> Un_ex (subst_tr_xu r)
...
let rec subst_pr a q r =
  ...
  match r with
    ...
    | Un_all r1           -> Un_all (subst_pr_aq r)
    | Un_ex  r1           -> Un_ex (subst_pr_aq r)
...
let rec usubst_tr c u r = 
  ...
  match r with
    ...
    | Un_all r1           -> Un_all (usubst_tr_cu r)
    | Un_ex  r1           -> Un_ex (usubst_tr_cu r)
