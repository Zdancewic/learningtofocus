...
module type S = sig
  ...
  OCaml Representation
      let tm11 = TM_param (idP1) in
      let tm12 = TM_fun (fun_id_12, [tm121, ..., tm12N12]) in
        ...
        ...
      let ap1 = (id11, [ tm11, ... , tm1N1 ] in
      let ap2 = (id21, [ tm21, ...,  tm2N2 ] in
       ...
      in
      let apG = (idG, [ tmG1, ..., tmGN ] in
      let seq : seqent = { assumptions = 
                            [ (id1, ap1) ; ... (idn, apn)];
                           goal = apG }


  Directed Acyclic Graph picture:      
             * SEQ 
        / \ ... \    \
       *a[0]   *a[1]   *a[n]   *g
   id /\ap  .....       [[ap]]
  ...
  Set of edges, where the nodes are generated by the occurrence of the data in the tree:
  (SEQ, a[0])
  (a[0], id[UID])
  ...
  <tag>   *   *  *    *
   ...
   build_graph_of_sequent (seq : sequent) (g : graph) : () =
       List.iter seq.assumptions (fun (id,prop) -> g.add "assumption" 
